...
namespace Sudoku
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Sudoku sudoku = new Sudoku("001006000040280900030000000805009000900154008000700309000000020006035090000900500");
            Sudoku sudoku = new Sudoku("000100700092000400500800006020470000009060100000051090300007008004000970008002000");
            sudoku = new Sudoku("000000000" +
                                "000000000" +
                                "000000000" +
                                "000000000" +
                                "000000000" +
